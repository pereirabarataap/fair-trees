...
def set_config(
    ...
    Examples
    --------
    >>> from fair_trees import set_config
...
def config_context(
    *,
    ...
    --------
    >>> import fair_trees
    >>> from fair_trees.utils.validation import assert_all_finite
    >>> with fair_trees.config_context(assume_finite=True):
    ...     assert_all_finite([float('nan')])
    >>> with fair_trees.config_context(assume_finite=True):
    ...     with fair_trees.config_context(assume_finite=False):
    ...         assert_all_finite([float('nan')])
