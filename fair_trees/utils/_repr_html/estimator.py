...
def estimator_html_repr(estimator):
    ...
    Examples
    --------
    >>> from fair_trees.utils._repr_html.estimator import estimator_html_repr
    >>> from fair_trees.linear_model import LogisticRegression
    >>> estimator_html_repr(LogisticRegression())
    '<style>#sk-container-id...'
    """
    from fair_trees.exceptions import NotFittedError
    from fair_trees.utils.validation import check_is_fitted
